    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                ...
                <p class="text-gray-400 mb-4">Your Blog is a platform that provides insightful articles on various topics written by expert authors.</p>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-400">contact@yourblog.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-center">
            <p class="text-gray-400 text-sm">
                &copy; {{ date('Y') }} Your Blog. All rights reserved.
            </p>
        </div>
    </div>
</footer>